...
(function initNetWizardI18n(root){
  ...
  "es": {
    ...
    "bundle.help": "El ZIP ejecuta la puerta estricta e incluye configuraciones, change set observado, evidencias, runbook y rollback.",
  ...
  "en": {
    ...
    "bundle.help": "The ZIP runs the strict production gate and includes configurations, observed change set, evidence, runbook and rollback.",
