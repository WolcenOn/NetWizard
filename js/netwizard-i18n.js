...
(function initNetWizardI18n(root){
  ...
  "es": {
    ...
    "app.version": "NetWizard v3.50 RC",
    ...
    "bundle.download": "🚀 Paquete de despliegue ZIP",
    "bundle.help": "El ZIP ejecuta la puerta estricta e incluye configuraciones, change set, candidatos incrementales seguros, evidencias y rollback.",
    "docs.card.title": "📑 Inventario, documentación y matriz",
    "docs.card.badge": "v3.50",
  ...
  "en": {
    ...
    "bundle.download": "🚀 Deployment package ZIP",
    "bundle.help": "The ZIP runs the strict production gate and includes configurations, change set, safe incremental candidates, evidence and rollback.",
