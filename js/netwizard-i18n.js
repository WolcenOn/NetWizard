...
(function initNetWizardI18n(root){
  ...
  "es": {
    ...
    "bundle.help": "El paquete ZIP ejecuta la puerta estricta e incluye configuraciones, snapshot, inventario, documentación y checklist.",
  ...
  "en": {
    ...
    "bundle.help": "The ZIP package runs the strict production gate and includes configurations, snapshot, inventory, documentation and checklist.",
